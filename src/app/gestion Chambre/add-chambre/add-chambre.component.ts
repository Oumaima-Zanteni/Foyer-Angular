...
export class AddChambreComponent {
  ...
  hideAddChambre() {
    this.hideAddChambreEvent.emit();
  }

  myForm: FormGroup;

  chambre: Chambre = {idChambre : 0 , numeroChambre: 0 , typeChambre: TypeChambre.SIMPLE,  bloc: { nomBloc: "A",capaciteBloc :0, idBloc:0 } };
...
/////////////
 ...
 /* @Input() showAddChambre: boolean;
  ...
  ngOnInit() {
    // Initialisation de la chambre avec des valeurs par défaut
    this.chambre = { idChambre: 0, numeroChambre: 0, typeChambre: TypeChambre.SIMPLE, bloc: { nomBloc: "A", capaciteBloc: 0, idBloc: 0 } };
  }*/
}
